...
<script type="text/javascript">
	var contextPath = "/farming";
		$(function(){
			...
			$('#prev').click(function(){
				location.href="<c:url value='/member/mypage/main'/>";
			});
          ...
          <div class="col-lg-7 mb-5 mb-lg-0"> 
			...
			<div class="d-flex mb-4" style="margin-left:42%">
              ...
              <div class="row form-block flex-column flex-sm-row">
            	...
            	<div class="col text-center text-sm-end" id="submit"><input type="submit" value="    수정    " id="edit" class="btn btn-primary px-3"></div>
	         </div>
            </form>
            </div>
          </div>
